    ...
    <div id="carouselExampleCaptions" class="carousel slide" data-bs-ride="carousel">
      ...
      <div class="carousel-inner">
        <div class="carousel-item active">
          <div class="row">
            <div class="col-lg-3 col-md-3 col-sm-5"><img src="img/coverbook.jpg" class="carousel-img" alt="..."></div>
            <div class="col-lg-9 col-md-9 col-sm-7 pos-middle">
              <div class="d-inline mt-4 mb-4">
                ...
                <button type="button" class="btn btn-carousel form-control mt-3">Lihat Buku</button>
              </div>
            </div>
          </div>
        </div>
